...
- Carpeta Guía1
   - src/main/java/Guia1
     ...
     - UsandoSystem.java (clase del ejercicio 1)
     - UsandoReader.java (clase del ejercicio 2)
   - pom.xml
- .gitignore
- README.md
...
- NO USAR READERS O BUFERED EN EL PUNTO 1 ESTA BIEN CLARO
...
## Observaciones y complicaciones, notas
- Sé que el if/else que revisa que el ángulo sea válido en el ejercicio 1B es muy largo (tiene demasiadas condiciones), pero intenté hacerlo legible. Si se considera mala práctica aún con la indentación que le puse me gustaría saber cómo mejorarlo!
- 
